...
public class BackendController {
    ...
    public ResponseModel helpList(@RequestParam(required = false) Short type, @RequestParam(required = false) Short status,
                                  @RequestParam(required = false) Short scid, @RequestParam(required = false) String keyword, @RequestParam(required = false) String beginTime,
